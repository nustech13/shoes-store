...
import shoesstore.validator.UserValidator;
...
public class UserController {
	...
	@PostMapping("add")
	public String addUser(@ModelAttribute("user") @Valid User user, BindingResult errors) {
		new UserValidator(userService).validate(user, errors);
		if (errors.hasErrors()) {
			return "user-form";
		}
