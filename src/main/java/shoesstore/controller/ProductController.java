...
import shoesstore.validator.ProductValidator;

@Controller
@RequestMapping("product")
public class ProductController {
	@Autowired
	private ProductService<Product, Integer> productDao;
	@Autowired
	...
	@PostMapping("add")
	public String addNewProduct(@ModelAttribute("product") @Valid Product product,BindingResult errors , Model model) {
		try {
			...
			new ProductValidator(productDao).validate(product, errors);
			if(errors.hasErrors()) {
				return "product-form";
			}
		} catch (Exception e) {
