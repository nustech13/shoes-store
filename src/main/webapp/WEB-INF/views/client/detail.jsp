        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                    	<img  height="400px" class="card-img " src="data:image/jpeg;base64,${product.image}">
                    </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body" data-id="${product.id}">
                            ...
                            <p class="h3 py-2"><fmt:setLocale value="vn"/><fmt:formatNumber value="${product.price }"/> VNĐ</p>
